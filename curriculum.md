...
###### This academic profile is not a full academic curriculul vitae (wich can be found **here**). Rather than an exhaustive record of a professional career, it aims to provide a selection of the titles, research, teaching and organizational activities, that I consider may have some interest.  Its structure is intended to help any eventual readers to find or locate what may be most relevant to them in terms of [Publications](publications.md)   books, chapters, articles, and other written work, [Interviews](interviews.md)  and media presence, reflecting the scholarly and public reception of my work,  [Research](research/projects.md) highlighting the most significant projects I have coordinated or participated in, the more meaningfull [Conferences and talks](onlinetalks.md) and recorded lectures documenting moments of exchange and debate, [Teaching](teaching_doctoral_program.md) and [Supervision](supervision.md), reflecting my long-standing commitment to the training of new generations, or and [Organization of Scientific meetings](organization_scientific_meetings.md) recording initiatives I have  helped to create and develop. 
